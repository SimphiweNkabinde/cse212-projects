...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue adds person to the front instead of the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: TestTakingTurns.GetNextPerson does not enqueue a person with 0 or less
